...
public class WhenGettingShortCourseEarnings
{
    ...
    [Test]
    public async Task ThenLearningStartedInPreviousYearWithPreviousPlannedEndAndNoActualEndIsExcluded()
    {
        const long ukPrn = 1000;
        const int collectionYear = 2425; // 2024-08-01 to 2025-07-31

        var learnerKey = Guid.NewGuid();
        _dbContext.LearnersDbSet.Add(new Learner { Key = learnerKey, Uln = "1001", FirstName = "A", LastName = "B" });

        var learning = new ShortCourseLearning
        {
            Key = Guid.NewGuid(),
            TrainingCode = "PREV001",
            Episodes =
            [
                new ShortCourseEpisode
                {
                    ...
                    TrainingCode = "PREV001",
                    StartDate = new DateTime(2023, 8, 1),
                    ExpectedEndDate = new DateTime(2024, 7, 31),
                    CompletionDate = null,
                    WithdrawalDate = null,
                    LearnerRef = "LRN1001"
                }
    ...
    [Test]
    public async Task ThenLearningStartedInPreviousYearWithPreviousPlannedEndAndCurrentYearActualEndIsIncluded()
    {
        const long ukPrn = 1000;
        const int collectionYear = 2425; // 2024-08-01 to 2025-07-31

        var learnerKey = Guid.NewGuid();
        _dbContext.LearnersDbSet.Add(new Learner { Key = learnerKey, Uln = "1002", FirstName = "A", LastName = "B" });

        var learning = new ShortCourseLearning
        {
            Key = Guid.NewGuid(),
            TrainingCode = "PREV002",
            Episodes =
            [
                new ShortCourseEpisode
                {
