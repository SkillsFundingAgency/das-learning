...
/// </summary>
public static class CreateDraftApprenticeshipExtensions
{
    /// <summary>
    ...
    public static LearningUpdateContext ToUpdateModel(this CreateDraftApprenticeship request)
    {
